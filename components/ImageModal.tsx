...
const ImageModal: React.FC<ImageModalProps> = ({ imageUrl, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-[#161b22] p-4 rounded-lg max-w-[90vw] max-h-[90vh] shadow-2xl"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute -top-4 -right-4 bg-gray-800 text-white rounded-full p-2 hover:bg-red-600 transition-colors focus:outline-none focus:ring-2 focus:ring-white"
